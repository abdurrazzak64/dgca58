        ...
        <div class="page-wrapper">
            ...
            <section class="up-comming-events">
                    ...
                    <div class="container-fluid headding-text mb-2">
                        <div class="col-12">
                            <h1 class="text-center">Conference Action Items</h1>
                        </div>
                    </div>
                    ...
                    <div class="snb only_web">
                        <div class="inner">
                            <ul  class="snb-list snb-list9">
                                ...
                                <li><a class="selected" href="conference-action-items.html">Action Items</a></li>
                    ...
                    <!-- <div class="submenu_2">
                        <div class="container">
                            <ul id="myactive">
                                ...
                                <a class="act actv" href="conference-action-items.html">Conference Action Items</a>
                                        ...
                                        <table id="tblwrap">
                                            ...
                                            <tbody> 
                                                ...
                                                <tr class="idx_15">	
                                                    ...
                                                    <td class="tit tit01">
                                                        <a href="#">	
                                                            List of Action Items arising from the 58th APAC DGCA (Dhaka, 4-19 October 2023)</a>
                                                    </td>	
