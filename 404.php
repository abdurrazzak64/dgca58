...
<html lang="en">
    <head>
        ...
        <title> DGCA 58th Conference</title>
        <!-- favicons Icons -->
        <link rel="apple-touch-icon" sizes="180x180" href="assets/images-2/logo/logo-dgca.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="assets/images-2/logo/logo-dgca.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="assets/images-2/logo/logo-dgca.png" />
        <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
        <meta name="description" content="Sopot HTML Template For Charity" />
    
         <!-- fonts -->
         <link href="https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"  as="font" type="font/otf" crossorigin>
    
         <link href="https://fonts.googleapis.com/css2?family=Fira+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"   as="font" type="font/otf" crossorigin>
        ...
        <link rel="stylesheet" href="assets/vendors/reg-form/css/style.min.css" />
        <!-- custom nivo  -->
        <link rel="stylesheet" href="assets/vendors/nivo-slider/themes/default/default.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="assets/vendors/nivo-slider/css/nivo-slider.css" type="text/css" media="screen" />
        <!-- customs form input  -->
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <!-- <link rel="stylesheet" href="assets/vendors/reg-form/css/master.min.css" /> -->
        <link rel="stylesheet" href="assets/vendors/reg-form/css/lightgallery.min.css" />
        <link rel="stylesheet" href="assets/vendors/reg-form/css/style.min.css" />
        <link rel="stylesheet" href="assets/vendors/reg-form/css/materialize.min.css" />
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            <div class="error-page__img zoom-fade">
                                <img src="assets/images/shapes/error-page-shape.png" alt="">
                            </div>
                            <p class="error-page__text">Sorry This Page Not found take a look at our most popular</p>
                            <div class="error-page__btn-box">
                                <a href="index.html" class="thm-btn error-page__btn">Go To Home</a>
                            </div>
                        </div>
                    </div>
                </div>
