        ...
        <div class="page-wrapper">
            ...
            <section class="up-comming-events">
                ...
                <div class="container-fluid headding-text mb-2">
                    <div class="col-12">
                        <h1 class="text-center">Excursion Day</h1>
                    </div>
                </div>
                ...
                <div class="snb only_web">
                    <div class="inner">
                        <ul  class="snb-list snb-list10">
                            ...
                            <li><a class="selected"  href="exe-day.html">Excursion Day</a></li>
                ...
                <!-- <div class="submenu_1">
                    <div class="container">
                        <ul id="myactive">
                            ...
                            <a class="act actv" href="exe-day.html">Excursion Day</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <!-- <p class="text-md-right">
                                <a class="pdf-dl2 mr-sm-2" href="Javascript:void(0);" download="">
                                    <img class="" src="assets/images-2/logo/pdf_32.png" alt="pdf icon">
                                    Announcement Notes
                                    <i class="fas fa-download ml-1"></i>
                                </a>
                                <br class="d-sm-none">
                                <a class="pdf-dl2 mt-2 mt-sm-0" href="Javascript:void(0);" download="">
                                    <img class="" src="assets/images-2/logo/pdf_32.png" alt="pdf icon">
                                    Transfer Schedule
                                    <i class="fas fa-download ml-1"></i>
                                </a>
                            ...
                            <h3 class="fs19 font-weight-bold">
                                Announcement Notes for Excursion
                                <br>
                                <small class="font-weight-bold">14 October, 2023</small>
                            </h3>
