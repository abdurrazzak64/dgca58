        ...
        <div class="page-wrapper">
            ...
            <section class="up-comming-events">
                    ...
                    <div class="container-fluid headding-text mb-2">
                        <div class="col-12">
                            <h1 class="text-center">Accompanying Person's Programme</h1>
                        </div>
                    </div>
                    ...
                    <div class="snb only_web">
                        <div class="inner">
                            <ul  class="snb-list snb-list10">
                                ...
                                <li><a class="selected" style="padding: 1.21% 0;" href="accom-persons-programme.html">Accompanying Person's Programme</a></li>
                    ...
                    <!-- <div class="submenu_1">
                        <div class="container">
                            <ul id="myactive">
                                ...
                                <a class="act actv" href="accom-persons-programme.html">Accompanying Person's Programme</a>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered mb-0 table-s1">
                                                <caption><span>Accompanying Person's Programme</span></caption>
                                                <thead>
                                                    <tr>
                                                        <th>Date</th>
                                                        <th>Programme</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h1>Notice :</h1>
                                                            <h4>※ Multiple choices are allowed.</h4>
                                                            <p>1. Please choose the course that you favor the most by 25th June.</p>

                                                            <p>2. Once acknowledged, detailed itinerary will be provided through your email. <br>  * The itinerary is subjected to change.</p>
                                                            <p>3. Please read the information carefully on the benefits and the exclusions of the following programs.</p>

                                                            <p>Ministry of Land, Infrastructure and Transport, Bangladesh thankfully acknowledge participation of the following partners in the sposorships and exhibiton held in conjunction with the 58th DGCA Conference of the Asia and Pacific Region.</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
