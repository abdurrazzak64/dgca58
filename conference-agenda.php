        ...
        <div class="page-wrapper">
            ...
            <section class="up-comming-events">
                    ...
                    <div class="container-fluid headding-text mb-2">
                        <div class="col-12">
                            <h1 class="text-center">Conference Agenda</h1>
                        </div>
                    </div>
                     ...
                     <div class="snb only_web">
                        <div class="inner">
                            <ul  class="snb-list snb-list9">
                                ...
                                <li><a class="selected"  href="conference-agenda.html">Agenda</a></li>
                    ...
                    <!-- <div class="submenu_2">
                        <div class="container">
                            <ul id="myactive">
                                ...
                                <a class="act actv" href="conference-agenda.html">Agenda</a>
